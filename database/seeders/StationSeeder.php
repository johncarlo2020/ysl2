...
class StationSeeder extends Seeder
{
    ...
    public function run()
    {
        Station::create([
            ...
            'description' => 'Strike a pose at the YSL Beauty Holiday pop-up at Raffles City External Quartzite, share your photo on social media & hashtag #YSLBeautySG #CelebrateInGold',
        ]);
